        ...
        <div class="row m-b-lg ">
            ...
            <div class="row text-center">
                <div class="contact-form col-md-6 col-sm-12 col-xs-12 col-md-offset-3 animated fadeInUp delayp3" style="opacity: 0;">                            
                   ...
                   {{ Form::open(array('url'=>'home/contactform', 'class'=>'form','parsley-validate'=>'','novalidate'=>' ')) }}             
                        <div class="form-group name">
                            <label for="name" class="sr-only">Name</label>
                              {{ Form::text('name', null,array('class'=>'form-control', 'placeholder'=>'Name:', 'required'=>'Name:'  )) }} 
                        </div><!--//form-group-->
                        <div class="form-group email">
                            <label for="email" class="sr-only">Email</label>
                             {{ Form::text('sender', null,array('class'=>'form-control', 'placeholder'=>'Email:', 'required'=>'Email:'  )) }} 
                        </div><!--//form-group-->
